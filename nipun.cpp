...
public:
    ...
    // Implement a feature to view reservations for a given passenger
    ...
    double minPrice = DBL_MAX; // Set initial minPrice to a very large value
    ...
    // Implement a feature to find the shortest path between airports (Dijkstra's algorithm)
